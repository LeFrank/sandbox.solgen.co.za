...
// oauth2_client_id, oauth2_client_secret, and to register your oauth2_redirect_uri.
 $client->setClientId('307365744122.apps.googleusercontent.com');
 $client->setClientSecret('iBrZKGImwBVwtNAbudVNkOD_');
 $client->setRedirectUri('http://sandbox.solgen.co.za/');
 $client->setDeveloperKey('http://sandbox.solgen.co.za/oauth2callback');
